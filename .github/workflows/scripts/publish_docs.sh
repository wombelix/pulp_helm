...
if [[ "$GITHUB_WORKFLOW" == "Helm changelog update" ]]; then
...
---
site_name: PulpHelm Client
site_description: Helm bindings
site_author: Pulp Team
site_url: https://docs.pulpproject.org/pulp_helm_client/
repo_name: pulp/pulp_helm
repo_url: https://github.com/pulp/pulp_helm
theme: readthedocs
DOCSYAML
...
# publish to docs.pulpproject.org/pulp_helm_client
rsync -avzh site/ doc_builder_pulp_helm@docs.pulpproject.org:/var/www/docs.pulpproject.org/pulp_helm_client/

# publish to docs.pulpproject.org/pulp_helm_client/en/{release}
rsync -avzh site/ doc_builder_pulp_helm@docs.pulpproject.org:/var/www/docs.pulpproject.org/pulp_helm_client/en/"$2"
