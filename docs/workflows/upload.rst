...
Response::
    ...
    {
        ...
        "pulp_href": "/pulp/api/v3/repositories/helm/helm/9b19ceb7-11e1-4309-9f97-bcbab2ae38b6/",
        ...
    }
...
Now that Pulp has the content, its time to make it into a unit of content::
    ...
    $ http POST ${BASE_ADDR}/pulp/api/v3/content/helm/helm artifact=${ARTIFACT_HREF} relative_path=my_content
...
Once there is a content unit, it can be added or removed::
    ...
    $ http POST ${BASE_ADDR}${REPO_HREF}modify/ add_content_units:="[\"http://localhost:24817/pulp/api/v3/content/helm/helm/ae016be0-0499-4547-881f-c56a1d0186a6/\"]"
