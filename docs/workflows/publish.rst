...
Publications contain extra settings for how to publish::
    ...
    $ http POST ${BASE_ADDR}/pulp/api/v3/publications/helm/helm/ repository=${REPO_HREF}
...
will serve the associated publication at ``/pulp/content/<distribution.base_path>``::
    ...
    $ http POST ${BASE_ADDR}/pulp/api/v3/distributions/helm/helm/ name='baz' base_path='foo' publication=${PUBLICATION_HREF}
