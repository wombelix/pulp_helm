...
Start by creating a new repository named "foo"::
    ...
    $ http POST ${BASE_ADDR}/pulp/api/v3/repositories/helm/helm/ name=foo

Response::

    {
        ...
        "pulp_href": "/pulp/api/v3/repositories/helm/helm/dfca3ec4-b5cf-474f-b561-25a9cb58f260/",
        ...
    }
...
Creating a remote object informs Pulp about an external content source::
    ...
    $ http POST ${BASE_ADDR}/pulp/pulp/api/v3/remotes/helm/helm/ name='bar' url='http://some.url/somewhere/'

Response::

    {
        ...
        "pulp_href": "/pulp/api/v3/remotes/helm/helm/e54203d8-afd5-4091-9fae-dad6419f8bfd/",
        ...
    }
...
Response::

    {
        ...
        "name": "pulp_helm.app.tasks.synchronizing.synchronize",
        "parent_task": null,
        "progress_reports": [
            {
        ...
        "reserved_resources_record": [
            "/pulp/api/v3/repositories/helm/helm/dfca3ec4-b5cf-474f-b561-25a9cb58f260/",
            "/pulp/api/v3/remotes/helm/helm/e54203d8-afd5-4091-9fae-dad6419f8bfd/"
        ],
