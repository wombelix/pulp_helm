...
from pulp_helm.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_helm import RemotesHelmApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesHelmApi(gen_helm_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesHelmApi(gen_helm_client()).create(body)
